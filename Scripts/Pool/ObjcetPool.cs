...
/// </summary>
public class ObjcetPool : SingletonForMonoBehaviour<ObjcetPool>
{
    ...
    public GameObject CreateObject(string key, GameObject go, Vector3 position, Quaternion quaternion)
    {
        ...
        for (int i = 0; i < tempgo.transform.childCount-1; i++)
        {
            tempgo.transform.GetChild(i).gameObject.SetActive(true);
        }
        return tempgo;          //返回
    }
